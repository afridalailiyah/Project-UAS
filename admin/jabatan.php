        ...
        <div class="row justify-content-center mb-2">
          ...
          <div class="col-sm text-right">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahJabatanModal">
              <i class="fas fa-fw fa-plus"></i> Tambah Jabatan</button>
            <!-- Modal -->
            <div class="modal fade text-left" id="tambahJabatanModal" tabindex="-1" role="dialog" aria-labelledby="tambahJabatanModalLabel" 
            aria-hidden="true">
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if ($dj['id_jabatan'] !== '1'): ?>
                          ...
                          <a href="ubah_jabatan.php?id_jabatan=<?= $dj['id_jabatan']; ?>" class="badge badge-success" data-toggle="modal" 
                          data-target="#editJabatanModal<?= $dj['id_jabatan']; ?>">
                            <i class="fas fa-fw fa-edit"></i> Ubah
                          </a>
                          <!-- Modal -->
                          <div class="modal fade" id="editJabatanModal<?= $dj['id_jabatan']; ?>" tabindex="-1" role="dialog" 
                          aria-labelledby="editJabatanModalLabel<?= $dj['id_jabatan']; ?>" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <form method="post">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="nama_jabatan" id="nama_jabatan<?= $dj['id_jabatan']; ?>" 
                                      class="form-control" value="<?= $dj['nama_jabatan']; ?>">
                                    </div>
                                  </div>
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-fw fa-times"></i>
                                     Close</button>
                                    <button type="submit" name="btnEditJabatan" class="btn btn-primary"><i class="fas fa-fw fa-save"></i>
                                     Save</button>
                                  </div>
                                </div>
                              </form>
                          ...
                          <a data-nama="<?= $dj['nama_jabatan']; ?>" class="btn-delete badge badge-danger" 
                          href="hapus_jabatan.php?id_jabatan=<?= $dj['id_jabatan']; ?>"><i class="fas fa-fw fa-trash"></i> Hapus</a>
                        <?php endif ?>
                      </td>
                    </tr>
                  <?php endforeach ?>
