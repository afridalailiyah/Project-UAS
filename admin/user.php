      ...
      <div class="container-fluid">
        <div class="row justify-content-center mb-2">
          ...
          <div class="col-sm text-right">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahUserModal"><i class="fas fa-fw fa-plus">

            </i> Tambah User</button>
            <!-- Modal -->
            <div class="modal fade text-left" id="tambahUserModal" tabindex="-1" role="dialog" aria-labelledby="tambahUserModalLabel" 
            aria-hidden="true">
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if ($du['id_jabatan'] !== '1'): ?>
                          ...
                          <a href="ubah_user.php?id_user=<?= $du['id_user']; ?>" class="badge badge-success" data-toggle="modal" 
                          data-target="#editUserModal<?= $du['id_user']; ?>">
                            <i class="fas fa-fw fa-edit"></i> Ubah
                          </a>
                          <!-- Modal -->
                          <div class="modal fade" id="editUserModal<?= $du['id_user']; ?>" tabindex="-1" role="dialog" aria-labelledby=
                          "editUserModalLabel<?= $du['id_user']; ?>" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <form method="post">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <div class="form-group">
                                      ...
                                      <input style="cursor: not-allowed;" disabled type="text" value="<?= $du['username']; ?>" id=
                                      "username<?= $du['id_user']; ?>" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                      <label for="nama_lengkap<?= $du['id_user']; ?>">Nama Lengkap</label>
                                      <input type="text" name="nama_lengkap" id="nama_lengkap<?= $du['id_user']; ?>" class="form-control" 
                                      required value="<?= $du['nama_lengkap']; ?>">
                                    </div>
                                    <div class="form-group">
                                  ...
                                  <div class="modal-footer">
                                    ...
                                    Close</button>
                                    <button type="submit" class="btn btn-primary" name="btnEditUser"><i class="fas fa-fw fa-save"></i> 
                                    Save</button>
                                  </div>
                                </div>
                              </form>
                          ...
                          <a data-nama="<?= $du['nama_lengkap']; ?>" class="btn-delete badge badge-danger" href="hapus_user.php?id_user=
                          <?= $du['id_user']; ?>"><i class="fas fa-fw fa-trash"></i> Hapus</a>
                        <?php endif ?>
                      </td>
                    </tr>
                  <?php endforeach ?>
