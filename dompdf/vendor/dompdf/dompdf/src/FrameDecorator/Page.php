...
class Page extends AbstractFrameDecorator
{
     ...
     *
     * https://www.w3.org/TR/CSS21/page.php#page-margins
     *
     * @var float
     */
     ...
     *
     * @link http://www.w3.org/TR/CSS21/page.php#forced
     *
    ...
    function check_forced_page_break(Frame $frame)
    {
        ...
        // here. See https://www.w3.org/TR/CSS21/visuren.php#anonymous-block-level
     ...
     * http://www.w3.org/TR/CSS21/page.php#allowed-page-breaks
     *
    ...
    protected function _page_break_allowed(Frame $frame)
    {
        ...
        if ($frame->is_block_level() || $display === "-dompdf-image") {
            ...
            // https://www.w3.org/TR/CSS21/visuren.php#anonymous-block-level
            $prev = $frame->get_prev_sibling();
            while ($prev && (($prev->is_text_node() && $prev->get_node()->nodeValue === "")
                || $prev->get_node()->nodeName === "bullet")
            ) {
