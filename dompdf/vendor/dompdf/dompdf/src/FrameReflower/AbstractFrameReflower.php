...
abstract class AbstractFrameReflower
{
     ...
     *
     * https://www.w3.org/TR/CSS21/visudet.php#containing-block-details
     */
     ...
     * http://www.w3.org/TR/CSS21/box.php#collapsing-margins
     */
     ...
     *
     * See http://www.w3.org/TR/CSS21/box.php#collapsing-margins.
     *
     * @param float $l1
     * @param float $l2
     *
     ...
     * https://www.w3.org/TR/CSS21/visuren.php#relative-positioning.
     *
     ...
     *
     * https://www.w3.org/TR/CSS21/generate.php#content
     *
    ...
    protected function _parse_content(): string
    {
        ...
        foreach ($content as $val) {
            ...
            if (mb_substr($val, 0, 7) === "counter") {
                ...
                // http://www.w3.org/TR/CSS21/generate.php#content
