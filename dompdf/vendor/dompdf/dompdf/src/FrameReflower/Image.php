...
class Image extends AbstractFrameReflower
{
     ...
     *
     * * https://www.w3.org/TR/CSS21/visudet.php#inline-replaced-width
     * * https://www.w3.org/TR/CSS21/visudet.php#inline-replaced-height
    ...
    protected function calculate_size(?float $cbw, ?float $cbh): array
    {
        ...
        if ($width === "auto" && $height === "auto") {
            ...
            // table in https://www.w3.org/TR/CSS21/visudet.php#min-max-widths
