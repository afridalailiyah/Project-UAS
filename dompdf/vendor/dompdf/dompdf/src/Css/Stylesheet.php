...
class Stylesheet
{
     ...
     * http://www.w3.org/TR/REC-html40/types.php
    ...
    /**
     * @link https://www.w3.org/TR/CSS21/cascade.php#specificity
     *
            ...
            foreach ($selector_styles as $style) {
                foreach ($nodes as $node) {
                    ...
                    foreach (array_keys($query["pseudo_elements"], true, true) as $pos) {
                        ...
                        // https://www.w3.org/TR/CSS21/generate.php#undisplayed-counters
